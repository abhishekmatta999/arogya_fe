...
export const googleUrl = "auth/login/google";
export const generateOtp = "auth/generate-otp";
export const verifyOtpUrl = "auth/signup";
export const fitnessDataUrl = "fitness/count";
export const searchFoodUrl = "users/search-food";
export const getReciepe = "users/generate-reciepe";
export const nutriCountUrl = "fitness/nutrients-count";
export const dietChartUrl = "users/export-user-diet";
